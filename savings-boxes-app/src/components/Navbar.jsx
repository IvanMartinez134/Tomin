...
export default function Navbar({ currentView, setCurrentView, userName = "Ángeles" }) {
  const navItems = [
    ...
    <div className="flex">
      ...
      <aside className="hidden lg:flex flex-col w-64 min-h-screen bg-white border-r border-gray-200">
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="w-16 h-16 bg-red-800 rounded-full flex items-center justify-center mx-auto mb-3">
        ...
        <header className="bg-white border-b border-gray-200 px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-gray-900">Sovereign Vault</span>
            </div>
